...
class Knight extends Piece{
    ...
    possibleMoves () {
        let moves = [];
        // Top
        const topNextNextSquare = this.board.getUpSquare(this.board.getUpSquare(this.position));
        ...
        // Bottom
        const bottomNextNextSquare = this.board.getDownSquare(this.board.getDownSquare(this.position));
        ...
        // Right
        const rightNextNextSquare = this.board.getRightSquare(this.board.getRightSquare(this.position));
        ...
        // Left
        const leftNextNextSquare = this.board.getRightSquare(this.board.getRightSquare(this.position));
